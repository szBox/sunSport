...
<script>
  import HelloDiv from './TselectDate1.vue'
  import LunDiv from './Trotate1.vue'
  export default{
    name:'teacher',
    data(){
      return{
    ...
    created(){
    	var self=this;
    	var banjiName=localStorage.getItem('banjiName');
    	self.banji=banjiName
    },
    components:{
      HelloDiv,
      LunDiv
